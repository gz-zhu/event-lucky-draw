...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    countdownSetSecondsFirst: 'Set the countdown seconds first',
    autoBtn: 'Auto',
    ...
    countdownUnit: 'min',
    countdownLabelShort: 'Countdown',
    currentPrizePoolLabel: 'Pool',
    currentPrizeSlotsLabel: 'Slots left',
    countdownClearHint: 'Leave prize blank to disable the countdown.',
    saveBtn: 'Save',
    discardBtn: 'Discard and close',
    discardBtnIcon: '✖ Discard and close',
  ...
  zh: {
    ...
    countdownSetSecondsFirst: '請先設定倒數秒數',
    autoBtn: '自動',
    autoTitle: '倒數結束時自動抽獎',
    drawBtn: '抽獎',
    exportCsvBtn: '匯出 CSV',
    ...
    selectPrize: '— 選擇獎項 —',
    countdownUnit: '分鐘',
    countdownLabelShort: '倒數',
    currentPrizePoolLabel: '獎池',
    currentPrizeSlotsLabel: '剩餘名額',
    countdownClearHint: '獎項留空則停用倒數。',
    saveBtn: '儲存',
    discardBtn: '放棄並關閉',
    discardBtnIcon: '✖ 放棄並關閉',
    recordsHeading: '抽獎紀錄',
    // ── Dynamic strings ────────────────────────────────────────
  ...
  ja: {
    ...
    countdownSetSecondsFirst: '先に秒数を設定してください',
    autoBtn: '自動',
    ...
    selectPrize: '— 賞を選択 —',
    countdownUnit: '分',
    countdownLabelShort: 'カウントダウン',
    currentPrizePoolLabel: 'プール',
    currentPrizeSlotsLabel: '残り枠',
    countdownClearHint: '賞を未選択にするとカウントダウンが無効になります。',
    saveBtn: '保存',
    discardBtn: '変更を破棄して閉じる',
    discardBtnIcon: '✖ 変更を破棄して閉じる',
    recordsHeading: '当選記録',
    // ── Dynamic strings ────────────────────────────────────────
  ...
  my: {
    ...
    countdownSetSecondsFirst: 'စက္ကန့်ကို အရင်သတ်မှတ်ပါ',
    autoBtn: 'အလိုအလျောက်',
    ...
    discardBtnIcon: '✖ မသိမ်းဘဲ ပိတ်ရန်',
